class UserTypesController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @user_type.save
        format.html { redirect_to @user_type, notice: "El rol de usuario #{@user_type.name} ha sido creado exitosamente." }
  ...
  def update
    ...
    respond_to do |format|
      if @user_type.update_attributes(params[:user_type])
        format.html { redirect_to @user_type, notice: "El rol de usuario #{@user_type.name} ha sido actualizado exitosamente." }
